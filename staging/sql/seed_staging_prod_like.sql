...
--   - 22222222-2222-2222-2222-222222222222 → Gasoil / AGO
...
VALUES
('57da330a-1305-4582-be45-ceab0f1aa795','11111111-1111-1111-1111-111111111111','TANK1',500000,0,'DAIPN LSHI','active',NOW(),'22222222-2222-2222-2222-222222222222'),
('905b3104-0324-4b5c-ba3d-ae1019746c70','11111111-1111-1111-1111-111111111111','TANK2',500000,0,'DAIPN LSHI','active',NOW(),'22222222-2222-2222-2222-222222222222'),
('7bf64a46-ca77-4857-af89-2e14d9128473','11111111-1111-1111-1111-111111111111','TANK3',500000,0,'DAIPN LSHI','active',NOW(),'22222222-2222-2222-2222-222222222222'),
('91d2078b-8e19-43c2-bf33-322a42cd4e94','11111111-1111-1111-1111-111111111111','TANK4',500000,0,'DAIPN LSHI','active',NOW(),'22222222-2222-2222-2222-222222222222'),
('a76a08a6-9017-421e-b5d3-afe8129a8f9d','11111111-1111-1111-1111-111111111111','TANK5',300000,0,'DAIPN LSHI','active',NOW(),'22222222-2222-2222-2222-222222222222'),
('6f3e0b4c-abfc-4b67-aaa0-2ca20a59ae1a','11111111-1111-1111-1111-111111111111','TANK6',300000,0,'DAIPN LSHI','active',NOW(),'22222222-2222-2222-2222-222222222222')
ON CONFLICT (id) DO UPDATE
