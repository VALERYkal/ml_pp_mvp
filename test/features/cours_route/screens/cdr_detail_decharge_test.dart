...
void main() {
  group('CDR Detail Screen - Déchargé Status Tests', () {
    ...
    testWidgets('should render without exceptions for déchargé status', (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        ProviderScope(
          overrides: [
            ...
            coursDeRouteByIdProvider(coursDecharge.id).overrideWith((ref) => AsyncValue.data(coursDecharge)),
    ...
    testWidgets('should display déchargé status chip', (WidgetTester tester) async {
      ...
      final chipWidget = tester.widget<Container>(find.ancestor(
        of: statutChip,
    ...
    testWidgets('should handle loading state', (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        ProviderScope(
          overrides: [
            coursDeRouteServiceProvider.overrideWithValue(fakeService),
            coursDeRouteByIdProvider(coursDecharge.id).overrideWith((ref) => const AsyncValue.loading()),
            userRoleProvider.overrideWith((ref) => UserRole.lecture),
    ...
    testWidgets('should handle error state', (WidgetTester tester) async {
      ...
      await tester.pumpWidget(
        ProviderScope(
          overrides: [
            coursDeRouteServiceProvider.overrideWithValue(fakeService),
            coursDeRouteByIdProvider(coursDecharge.id).overrideWith((ref) => AsyncValue.error('Test error', StackTrace.current)),
            userRoleProvider.overrideWith((ref) => UserRole.lecture),
            refDataProvider.overrideWith((ref) => AsyncValue.error('Ref data error', StackTrace.current)),
          ],
          child: MaterialApp(
            home: CoursRouteDetailScreen(coursId: coursDecharge.id),
          ),
    ...
    testWidgets('should handle not found state', (WidgetTester tester) async {
      ...
      expect(find.text('Le cours de route demandé n\'existe pas ou a été supprimé.'), findsOneWidget);
    });
  });
}
