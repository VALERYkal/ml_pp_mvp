...
void main() {
  group('SortiesKpiProvider (deprecated)', () {
    test(
      ...
      () {},
      skip: 'Deprecated: remplacé par test/features/kpi/sorties_kpi_provider_test.dart (provider moderne) et test/features/kpi/kpi_sorties_compute_test.dart (fonction pure). Ancienne suite dépendait de Supabase.instance.',
    );
  });
}
