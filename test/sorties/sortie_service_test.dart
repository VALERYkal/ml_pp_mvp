...
class FakeStocksService {
  ...
  Future<double> getAmbientForToday({required String citerneId, required String produitId}) async => ambientToday;
  Future<double> getV15ForToday({required String citerneId, required String produitId}) async => v15Today;
