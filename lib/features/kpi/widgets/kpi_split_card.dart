...
class KpiSplitCard extends StatelessWidget {
        ...
        child: DefaultTextStyle(
          ...
          child: Column(
            ...
            children: [
              ...
              Row(children: [
                Expanded(child: _metric(context, leftLabel, leftValue, leftSubLabel, leftSubValue, accent: leftAccent)),
                const SizedBox(width: 12),
                Expanded(child: _metric(context, rightLabel, rightValue, rightSubLabel, rightSubValue, accent: rightAccent)),
              ]),
            ],
          ),
        ),
  ...
  Widget _metric(BuildContext context, String label, String value, String? subLabel, String? subValue, {Color? accent}) {
