...
final coursKpiProvider = FutureProvider.family<CoursCounts, ({String? depotId, String? produitId})>(
  (ref, p) async {
    final repo = ref.watch(coursDeRouteRepoProvider);
    return await repo.countsEnRouteEtAttente(depotId: p.depotId, produitId: p.produitId);
  },
);
