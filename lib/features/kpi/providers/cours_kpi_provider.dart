...
final coursDefaultParamProvider =
    Provider<({String? depotId, String? produitId})>((ref) {
      final profil = ref
...
final coursKpiProvider =
    FutureProvider.family<CoursCounts, ({String? depotId, String? produitId})>((
      ref,
      p,
    ) async {
