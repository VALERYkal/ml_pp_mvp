...
final receptionServiceProvider = Riverpod.Provider<ReceptionService>((ref) {
  ...
  return ReceptionService.withClient(Supabase.instance.client, refRepo: refRepo);
});

final createReceptionProvider = Riverpod.FutureProvider.family<String, ReceptionInput>((
  ref,
  input,
) async {
