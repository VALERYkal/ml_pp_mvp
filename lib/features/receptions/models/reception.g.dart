...
_$ReceptionImpl _$$ReceptionImplFromJson(Map<String, dynamic> json) => _$ReceptionImpl(
  ...
  proprietaireType: const OwnerTypeConverter().fromJson(json['proprietaire_type'] as String),
...
Map<String, dynamic> _$$ReceptionImplToJson(_$ReceptionImpl instance) => <String, dynamic>{
  'id': instance.id,
  ...
  'proprietaire_type': const OwnerTypeConverter().toJson(instance.proprietaireType),
