...
Map<String, dynamic> _$$ReceptionInputImplToJson(_$ReceptionInputImpl instance) =>
    <String, dynamic>{
      ...
      if (instance.dateReception?.toIso8601String() case final value?) 'dateReception': value,
