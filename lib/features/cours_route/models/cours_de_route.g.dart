...
_$CoursDeRouteImpl _$$CoursDeRouteImplFromJson(Map<String, dynamic> json) => _$CoursDeRouteImpl(
...
Map<String, dynamic> _$$CoursDeRouteImplToJson(_$CoursDeRouteImpl instance) => <String, dynamic>{
  'id': instance.id,
  ...
  if (instance.dateChargement?.toIso8601String() case final value?) 'date_chargement': value,
  if (instance.dateArriveePrevue?.toIso8601String() case final value?) 'date_arrivee_prevue': value,
