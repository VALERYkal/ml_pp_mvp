...
_$SortieProduitImpl _$$SortieProduitImplFromJson(Map<String, dynamic> json) => _$SortieProduitImpl(
  ...
  temperatureAmbianteC: (json['temperature_ambiante_c'] as num?)?.toDouble(),
  ...
  dateSortie: json['date_sortie'] == null ? null : DateTime.parse(json['date_sortie'] as String),
...
Map<String, dynamic> _$$SortieProduitImplToJson(_$SortieProduitImpl instance) => <String, dynamic>{
  'id': instance.id,
  ...
  if (instance.temperatureAmbianteC case final value?) 'temperature_ambiante_c': value,
  if (instance.densiteA15 case final value?) 'densite_a_15': value,
  'statut': instance.statut,
  'proprietaire_type': instance.proprietaireType,
  if (instance.dateSortie?.toIso8601String() case final value?) 'date_sortie': value,
