  ...
  factory ReceptionInsertException.fromPostgrest(
    ...
    switch (code) {
      ...
      case '23514': // check_violation
        ...
        } else if (message.contains('index_apres') ||
            message.contains('index_avant')) {
          userMsg =
              'Les indices sont incohérents (index après doit être > index avant).';
        } else if (message.contains('volume_ambiant') ||
            message.contains('volume_corrige_15c')) {
