    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [BoxShadow(blurRadius: 24, color: Colors.black.withOpacity(0.06), offset: const Offset(0,12))],
        ),
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              // primary value
              Text(primaryValue, style: t.textTheme.headlineMedium?.copyWith(fontWeight: FontWeight.w800)),
              if (primaryLabel != null) ...[
                const SizedBox(height: 4),
                Text(primaryLabel!, style: t.textTheme.bodyMedium?.copyWith(color: t.colorScheme.onSurfaceVariant)),
              ],
              const SizedBox(height: 12),
              // bottom band
              Container(
                ...
                child: Row(children: [
                  Expanded(child: _Mini(label: subLeftLabel, value: subLeftValue)),
                  const SizedBox(width: 16),
                  Expanded(child: _Mini(label: subRightLabel, value: subRightValue)),
                ]),
              ),
            ],
          ),
